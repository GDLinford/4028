...
{
	//Initialise window dimension, x, y, width and heigh can be passed as zero to use defaults
...
unsigned int Console::WriteToLocation(wchar_t* a_data, short a_numCharacters, short a_xPos, short a_yPos) 
{
	...
	//multiply num character by size of wchar_t (2) to get number of bytes to write.
